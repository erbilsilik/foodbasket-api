...
<html>
<head>
    <title>adminStyle Dashboard HTML Template</title>
    <meta charset="utf-8">
    ...
    <div class="search-with-suggestions-w">
        <div class="search-with-suggestions-modal">
            <div class="element-search">
                <input class="search-suggest-input" placeholder="Restaurant Search ..." type="text">
    ...
    <div class="layout-w">
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
            <div class="mm-logo-buttons-w">
                <a class="mm-logo" href="index.html"><img src="{{ asset('adminStyle/') }}img/logo.png"><span>Clean adminStyle</span></a>
            ...
            <div class="menu-and-user">
                <div class="logged-user-w">
                    <div class="avatar-w">
                        <img alt="" src="{{ asset('adminStyle/') }}img/avatar1.jpg">
                    </div>
                ...
                <ul class="main-menu">
                    ...
                    <li class="has-sub-menu">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a href="icon_fonts_light_admin.html">Light adminStyle</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="mobile-menu-magic">
                    ...
                    <div class="btn-w">
                        <a class="btn btn-white btn-rounded" href="https://themeforest.net/item/light-adminStyle-clean-bootstrap-dashboard-html-template/19760124?ref=Osetin" target="_blank">Purchase Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="menu-w color-scheme-light color-style-transparent menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
            ...
            @include('RestaurantAdmin/Layouts/Sidebar')
...
<script src="{{ asset('adminStyle/bower_components/popper.js/dist/umd/popper.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/moment/moment.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/select2/dist/js/select2.full.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/jquery-bar-rating/dist/jquery.barrating.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap-validator/dist/validator.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/ion.rangeSlider/js/ion.rangeSlider.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/dropzone/dist/dropzone.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/editable-table/mindmup-editabletable.js') }}"></script>
...
<script src="{{ asset('adminStyle/bower_components/fullcalendar/dist/fullcalendar.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/tether/dist/js/tether.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/slick-carousel/slick/slick.min.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/util.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/alert.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/button.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/carousel.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/collapse.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/dropdown.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/modal.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/tab.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/tooltip.js') }}"></script>
<script src="{{ asset('adminStyle/bower_components/bootstrap/js/dist/popover.js') }}"></script>
<script src="{{ asset('adminStyle/js/dataTables.bootstrap4.min.js') }}"></script>

<script src="{{ asset('adminStyle/js/demo_customizer.js?version=4.4.0') }}"></script>
<script src="{{ asset('adminStyle/js/main.js?version=4.4.0') }}"></script>
</body>
</html>
